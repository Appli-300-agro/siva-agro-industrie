# Siva Agro Industrie - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Siva Agro Industrie**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@sivaagroindustrie.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@sivaagroindustrie.cm` | `user123` | |
...
*   **Contact :** contact@sivaagroindustrie.cm